...
const AllAmbassadors = () => {
  ...
  console.log(ambassadorsData?.data)
  const teamMembers = [
    {
      name: "Dawn Campbell",
      ...
      {ambassadorsData?.data?.map((member, index) => (
        ...
        >
          ...
          <div className="flex-1">
            ...
            {/* Description */}
            <p className="text-[#141414] leading-relaxed mb-4 font-medium" dangerouslySetInnerHTML={{__html:member.description}}>
 ...
 <div className="mb-6">
  ...
  <div className="flex flex-wrap gap-4">
    {member.specialties.map((category, i) => (
      <span key={i} className="text-sm text-[#141414] bg-[#30B7671A] cursor-pointer py-1 px-2 rounded-full">
        {category}
      </span>
    ))}
  </div>
