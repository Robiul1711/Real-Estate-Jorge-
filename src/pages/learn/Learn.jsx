...
const Learn = () => {
      const {
        ...
        queryKey: ["learn"],
        url: "cms/learn_page/banner_section",
        secure: true,
      });
      // --- Skeleton Loader ---
if (isLoading) {
  ...
  return (
    <>
      <ScrollRestoration />
      <Banner
        title={LernData?.data?.banner_section?.title}
        subtitle={""}
        image={LernData?.data?.banner_section?.image}
        description={
          LernData?.data?.banner_section?.description
        }
      />
      <InvestmentGuide />
      <CommonBanner />
