...
const Statistics = () => {
    const {
      ...
      queryKey: ["statistics"],
      url: "cms/statistic_page/banner_section",
      secure: true,
    });
      // --- Skeleton Loader ---
if (isLoading) {
  ...
  return (
    <>
      <ScrollRestoration />
      <Banner
      image={statisticsData?.data?.banner_section?.image}
        title={statisticsData?.data?.banner_section?.title}
        subtitle={""}
        description={
         statisticsData?.data?.banner_section?.description
        }
      />
      <MarketLeader />
    </>
