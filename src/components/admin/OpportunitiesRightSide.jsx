    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="border rounded-2xl p-6 shadow-2xl bg-white">
        ...
        <div className="grid grid-cols-2 gap-4 my-5">
          <div>
            <p className="font-semibold text-gray-500 flex items-center gap-1"><AiOutlineRise className='text-green-500'/>Expected Return</p>
            <p className="text-sm text-green-500">12-15%</p>
          </div>
          <div>
            <p className="font-semibold text-gray-500 flex items-center gap-1"><FaCalendarAlt />Duration</p>
        ...
        <div className="grid grid-cols-2 gap-4 mb-5 border-b pb-4">
          <div>
            <p className="font-semibold text-gray-500 flex items-center gap-1"><MdOutlinePeopleOutline />Investors</p>
