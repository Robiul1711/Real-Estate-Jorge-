...
const FinancialInformation = () => {
  ...
  const costData = [
    { name: 'Land Acquisition', value: 1200000, color: '#3B82F6' },
    { name: 'Construction', value: 1800000, color: '#1E40AF' },
    { name: 'Legal & Admin', value: 150000, color: '#FCD34D' },
    { name: 'Marketing', value: 850000, color: '#374151' }
  ];
  ...
  <div className="group bg-white rounded-lg p-6 shadow-sm hover:bg-black transition duration-300">
    <div className="flex items-center justify-between">
      <div>
        <p className="text-sm text-gray-600 group-hover:text-gray-300">Total Project Cost</p>
        <p className="text-2xl font-bold text-gray-900 group-hover:text-white">$3.2M</p>
      </div>
  ...
  <div className="group bg-white rounded-lg p-6 shadow-sm hover:bg-black transition duration-300">
    <div className="flex items-center justify-between">
      <div>
        ...
        <p className="text-2xl font-bold text-gray-900 group-hover:text-white">$4.8M</p>
      </div>
  ...
  <div className="group bg-white rounded-lg p-6 shadow-sm hover:bg-black transition duration-300">
    <div className="flex items-center justify-between">
      <div>
        <p className="text-sm text-gray-600 group-hover:text-gray-300">ROI</p>
        <p className="text-2xl font-bold text-gray-900 group-hover:text-white">50%</p>
        <p className="text-xs text-gray-500 group-hover:text-gray-400">Profit Margin</p>
      </div>
  ...
  <div className="group bg-white rounded-lg p-6 shadow-sm hover:bg-black transition duration-300">
    <div className="flex items-center justify-between">
      <div>
        <p className="text-sm text-gray-600 group-hover:text-gray-300">IRR</p>
        <p className="text-2xl font-bold text-gray-900 group-hover:text-white">13.5%</p>
      </div>
      <Clock className="h-8 w-8 text-gray-400 group-hover:text-white" />
        ...
        <div className="grid grid-cols-1  gap-6">
          ...
          <div className="bg-white rounded-lg p-6 shadow-sm">
            <h3 className="text-lg font-semibold text-gray-900 mb-6">Project Cost Breakdown</h3>
            <div className="flex items-center justify-between">
